  ...
  ngOnInit() {
    ...
    editCont(){
      if(this.referenceType){
        this.crudService.updateContractRef(this.data,this.selectedValueDeleg,this.referenceType);
      }else{
        this.crudService.updateContractRef(this.data,this.selectedValue,this.referenceType);
      }
